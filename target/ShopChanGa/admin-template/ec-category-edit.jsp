            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="admin-product?command=category">Danh mục sản phẩm</a></li>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-12">
                                    <div class="preview preview-pic tab-content">
                                        <div class="tab-pane active" id="product_a"><img
                                                src="<%=categories.getImgC()%>" class="img-fluid"
                                                alt=""/>
                                        </div>
                                    </div>
                                    <button class="btn-primary btn" onclick="show()">Tải ảnh lên</button>
                                ...
                                <div class="col-xl-9 col-lg-8 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="nameC" class="form-control"
                                               value="<%=categories.getNameC()%>" placeholder="Tên danh mục">
                                    </div>
                                    <% if (map!=null){%>
                                    <input type="hidden" id="imgC" value="<%=img1%>">
                                    <%} else {%>
                                    <input type="hidden" id="imgC" value="<%=categories.getImgC()%>">
                                    <%}%>
                                    <button type="submit" onclick="saveTrademark(<%=categories.getIdC()%>)"
    ...
    form.addEventListener('submit', (event) => {
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                window.location.href = "admin-product?command=editC&IdC=<%=categories.getIdC()%>";
            } else {
