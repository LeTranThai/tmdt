!function (a, b) {
    ...
    a.arr = {}, a.arr.each = function (b, c) {
        if (a.is.array(b) && a.is.fn(c)) for (var d = 0, e = b.length; e > d && !1 !== c(b[d], d); d++) ;
    ...
    a.is = {}, a.is.type = function (a, b) {
        ...
        return !a.is.array(b) || 0 === b.length
    }, a.is.emptyString = function (b) {
        return !a.is.string(b) || 0 === b.length
    }
}(FooTable), function (a) {
    a.str = {}, a.str.contains = function (b, c, d) {
        return !a.is.emptyString(b) && !a.is.emptyString(c) && (c.length <= b.length && -1 !== (d ? b.toUpperCase().indexOf(c.toUpperCase()) : b.indexOf(c)))
    }, a.str.containsExact = function (b, c, d) {
        return !(a.is.emptyString(b) || a.is.emptyString(c) || c.length > b.length) && new RegExp("\\b" + a.str.escapeRegExp(c) + "\\b", d ? "i" : "").test(b)
        ...
        return (b = a.is.emptyString(b) ? "" : b) + Math.random().toString(36).substr(2, 9)
    ...
    b.Cell = b.Class.extend({
        construct: function (a, b, c, d) {
            ...
            var e = this, f = b.is.hash(c) && b.is.hash(c.options) && b.is.defined(c.value);
            if (this.o = a.extend(!0, {
                ...
                var g = this.$detail.children("td").first().empty(), h = b.is.jq(this.$detail.parent()) ? g : this.$el;
                h.append(this.format(this.value)), this._setClasses(h), this._setStyle(h), (!b.is.boolean(d) || d) && this.row.draw()
            }
    ...
    b.Component = b.Class.extend({
        construct: function (a, c) {
            ...
            this.ft = a, this.enabled = !!b.is.boolean(c) && c
        }, preinit: function (a) {
        }, init: function () {
        }, destroy: function () {
        }, predraw: function () {
    ...
    b.Row = b.Class.extend({
        construct: function (a, b, c) {
            ...
            this.collapse(!1);
            var f = b.is.hash(c), g = f && b.is.hash(c.options) && b.is.hash(c.value);
            if (this.o = a.extend(!0, {
                expanded: e.expanded,
                classes: e.classes,
                style: e.style
            }, g ? c.options : {}), this.expanded = this.o.expanded, this.classes = b.is.array(this.o.classes) ? this.o.classes : b.is.string(this.o.classes) ? this.o.classes.match(/\S+/g) : [], this.style = b.is.hash(this.o.style) ? this.o.style : b.is.string(this.o.style) ? b.css2json(this.o.style) : {}, f) if (g && (c = c.value), b.is.hash(this.value)) for (var h in c) c.hasOwnProperty(h) && (this.value[h] = c[h]); else this.value = c; else this.value = null;
            b.arr.each(this.cells, function (a) {
                b.is.defined(e.value[a.column.name]) && a.val(e.value[a.column.name], !1)
            }), this.created && (this._setClasses(this.$el), this._setStyle(this.$el), (!b.is.boolean(d) || d) && this.draw())
        }, _setClasses: function (a) {
            ...
            if (this.created) {
                ...
                c.ft.raise("collapse.ft.row", [c]).then(function () {
                    b.arr.each(c.__hidden__, function (a) {
                        a.restore()
                    }), c.$details.detach(), c.$el.removeAttr("data-expanded"), c.$toggle.removeClass("fooicon-minus").addClass("fooicon-plus"), (!b.is.boolean(a) || a) && (c.expanded = !1)
                })
            }
        }, predraw: function (a) {
            this.created && (this.expanded && this.collapse(!1), this.$toggle.detach(), (a = !b.is.boolean(a) || a) && this.$el.detach())
        }, draw: function (a) {
    ...
    b.Breakpoints = b.Component.extend({
        construct: function (a) {
            ...
            for (var a, c = this, d = null, e = [], f = null, g = c.getWidth(), h = 0, i = c.array.length; i > h; h++) a = c.array[h], (!d && h == i - 1 || g >= a.width && (!(f instanceof b.Breakpoint) || g < f.width)) && (d = a), d || e.push(a.name), f = a;
    ...
    b.Rows = b.Component.extend({
        construct: function (a) {
            ...
            b.arr.each(this.array, function (a) {
                a.predraw()
            }), this.all = b.is.boolean(d) && d ? this.all.concat(f) : f, this.array = this.all.slice(0), this.ft.draw()
        }, expand: function () {
            b.arr.each(this.array, function (a) {
                a.expand()
            })
    ...
    a.Filter = a.Class.extend({
        construct: function (b, c, d, e, f, g, h) {
            this.name = b, this.space = !a.is.string(e) || "OR" != e && "AND" != e ? "AND" : e, this.connectors = !a.is.boolean(f) || f, this.ignoreCase = !a.is.boolean(g) || g, this.hidden = !!a.is.boolean(h) && h, this.query = c instanceof a.Query ? c : new a.Query(c, this.space, this.connectors, this.ignoreCase), this.columns = d
        }, match: function (b) {
            return !!a.is.string(b) && (a.is.string(this.query) && (this.query = new a.Query(this.query, this.space, this.connectors, this.ignoreCase)), this.query instanceof a.Query && this.query.match(b))
        }, matchRow: function (b) {
    ...
    b.Filtering = b.Component.extend({
        construct: function (a) {
            ...
            d.ft.$el.addClass("footable-filtering").addClass(c), d.$row = a("<tr/>", {class: "footable-filtering"}).prependTo(d.ft.$el.children("thead")), d.$cell = a("<th/>").attr("colspan", d.ft.columns.visibleColspan).appendTo(d.$row), d.$form = a("<form/>", {class: "form-inline"}).append(e).appendTo(d.$cell), d.$input = a("<input/>", {
                type: "text",
                class: "form-control",
                ...
                return b.filterable ? a("<li/>").append(a("<a/>", {class: "checkbox"}).append(a("<label/>", {text: b.title}).prepend(a("<input/>", {
                    type: "checkbox",
                    checked: !0
            ...
            return b.is.emptyArray(a) || b.arr.each(a, function (a) {
                (a = c._ensure(a, e)) instanceof b.Filter && d.push(a)
            }), d
            ...
            return (b.is.hash(a) || a instanceof b.Filter) && !b.is.emptyString(a.name) && (!b.is.emptyString(a.query) || a.query instanceof b.Query) ? (a.columns = b.is.emptyArray(a.columns) ? c : this.ft.columns.ensure(a.columns), a.ignoreCase = b.is.boolean(a.ignoreCase) ? a.ignoreCase : this.ignoreCase, a.connectors = b.is.boolean(a.connectors) ? a.connectors : this.connectors, a.hidden = !!b.is.boolean(a.hidden) && a.hidden, a.space = !b.is.string(a.space) || "AND" !== a.space && "OR" !== a.space ? this.space : a.space, a.query = b.is.string(a.query) ? new b.Query(a.query, a.space, a.connectors, a.ignoreCase) : a.query, a instanceof b.Filter ? a : new b.Filter(a.name, a.query, a.columns, a.space, a.connectors, a.ignoreCase, a.hidden)) : null
            ...
            a.preventDefault();
            var b = a.data.self;
            if (null != b._filterTimeout && clearTimeout(b._filterTimeout), b.$button.children(".fooicon").hasClass("fooicon-remove")) b.clear(); else {
                var c = b.$input.val();
                c.length >= b.min && (b.exactMatch && !b._exactRegExp.test(c) && (c = '"' + c + '"'), b.addFilter("search", c), b.filter())
            }
    ...
    a.Query = a.Class.extend({
        construct: function (b, c, d, e) {
            this._original = null, this._value = null, this.space = !a.is.string(c) || "OR" != c && "AND" != c ? "AND" : c, this.connectors = !a.is.boolean(d) || d, this.ignoreCase = !a.is.boolean(e) || e, this.left = null, this.right = null, this.parts = [], this.operator = null, this.val(b)
        }, val: function (b) {
    ...
    a.Row.prototype.filtered = function (b) {
        ...
        return a.arr.each(b, function (a) {
            return 0 != (c = a.matchRow(d)) && void 0
        }), c
    }
}(FooTable), function (a, b) {
    ...
    b.Column.prototype.direction = null, b.Column.prototype.sortable = !0, b.Column.prototype.sorted = !1, b.Column.prototype.sorter = function (a, b) {
        ...
        this.sorter = b.checkFnValue(this, a.sorter, this.sorter), this.direction = b.is.type(a.direction, "string") ? b.Sorting.dir(a.direction) : null, this.sortable = !b.is.boolean(a.sortable) || a.sortable, this.sorted = !!b.is.boolean(a.sorted) && a.sorted, this.sortValue = b.checkFnValue(this, a.sortValue, this.sortValue)
    }, b.Column.extend("define", function (a) {
        this._super(a), this.__sorting_define__(a)
    })
}(jQuery, FooTable), function (a) {
