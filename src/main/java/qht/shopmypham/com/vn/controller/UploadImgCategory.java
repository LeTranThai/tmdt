...
@WebServlet("/UploadImgCategory")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 50, // 50MB
        maxRequestSize = 1024 * 1024 * 50) // 50MB
public class UploadImgCategory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String parthImg = "user-template/img/category/" + nameImg;
        ...
        session.setAttribute("imgsCategory", map);
    }
    ...
    public File getFolderUpload() {
        String avatarPath = "user-template/img/category"; // đường dẫn tương đối của tài nguyên
