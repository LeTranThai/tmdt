...
@WebServlet("/UploadLogoTrademark")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 50, // 50MB
        maxRequestSize = 1024 * 1024 * 50) // 50MB
public class UploadLogoTrademark extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String parthImg = "user-template/img/trademark/" + nameImg;
        ...
        session.setAttribute("imgsTrademark", map);
    }
    ...
    public File getFolderUpload() {
        String avatarPath = "user-template/img/trademark"; // đường dẫn tương đối của tài nguyên
